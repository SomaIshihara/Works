...
{
	{"data/BGM/Moonside_Howl.wav", -1},		// タイトルBGM
	{"data/BGM/Secret_Adventure.wav", -1},	// ゲームBGM
	{"data/SE/Start.wav", 0 },				// タイトルでEnter
	{"data/SE/Jump.wav", 0 },				// ジャンプ
	{"data/SE/Item.wav", 0 },				// アイテム拾う
	{"data/SE/ChangeMode.wav", 0 },			// モード切り替え
	{"data/SE/Build.wav",0},				//ブロック配置・撤去
	{"data/SE/GameClear.wav",0},			// クリア
	{"data/SE/GameOver.wav",0},				// 失敗
};
